...
public class Ex_3 {
    ...
    public static void main(String[] args) {
        ...
        String nome;
        double salariof, totalv,bonus, totalreceber;
        System.out.println("Informe seu nome: ");
        nome = s.next();
        System.out.println("Informe seu salário fixo: ");
        salariof = s.nextDouble();
        System.out.println("Informe o total de vendas em dinheiro que você realizou: ");
        totalv = s.nextDouble();
        totalreceber = (totalv*0.15)+salariof;
        System.out.println(nome);
        System.out.printf("Seu salário com o bonûs de venda é de: %.2f", totalreceber);
    }
